...
public class Main extends Application {
    ...
    public static void main(String[] args) {
        ...
        defaultGames.add(new Game("Counter-Strike: Source", "Multiplayer FPS", "Counter-Strike: Source, released in 2004, is a first-person shooter game developed by Valve Corporation. It's a remake of the original Counter-Strike using the Source game engine.", 2004));
        ...
        defaultGames.add(new Game("Left 4 Dead", "Co-op FPS", "Left 4 Dead, released in 2008, is a cooperative first-person shooter developed by Valve Corporation. Set in a post-apocalyptic world overrun by a zombie outbreak, players assume the roles of four survivors as they navigate through various environments, battling hordes of infected and working together to reach safe zones.", 2008));
        defaultGames.add(new Game("Left 4 Dead 2", "Co-op FPS", "Left 4 Dead 2, released in 2009, is a cooperative first-person shooter developed by Valve Corporation, serving as a sequel to the original Left 4 Dead. Set in the aftermath of a zombie apocalypse, players assume the roles of four survivors as they navigate through various environments, battling hordes of infected and working together to reach safe zones.", 2009));

        users.add(new User("abc", "1234", defaultGames));
        users.add(new User("SigmaCreeper", "qwerty", defaultGames));
